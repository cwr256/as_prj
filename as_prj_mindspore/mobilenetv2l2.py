...
class ConvBNPReLU(nn.Cell):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, pad_mode='same', padding=0):
        ...
        self.conv = Conv2d(in_channels, out_channels, kernel_size, stride, pad_mode=pad_mode, padding=padding,
                           has_bias=False)
...
class InvertedResidual(nn.Cell):
    def __init__(self, in_channels, out_channels, stride, expansion):
        ...
        self.conv3 = Conv2d(hidden_dim, out_channels, kernel_size=1, has_bias=False)
        self.bn = BatchNorm2d(out_channels)
        self.prelu = PReLU()
...
class MobileNetV2(nn.Cell):
    def __init__(self, num_classes=38, width_mult=1.0):
        ...
        self.conv_final = Conv2d(1280, num_classes, kernel_size=1, has_bias=True)
        self.bn_final = BatchNorm2d(num_classes)
...
# Usage example:
net = MobileNetV2(num_classes=38, width_mult=1.0)
# print(net)